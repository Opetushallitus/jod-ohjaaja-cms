...
public class ArquillianConnector {
  ...
  static {
    try {
      // Tämä sitoo socketin kaikkiin saatavilla oleviin verkkorajapintoihin.
      _inetAddress = InetAddress.getByName("0.0.0.0");
    } catch (UnknownHostException e) {
      // Tämä on epätodennäköinen virhe, mutta se on pakko käsitellä.
      // Heitetään RuntimeException, jotta ohjelma kaatuu, jos osoitetta ei löydy.
      throw new RuntimeException("Could not initialize bind address", e);
    }
  }
