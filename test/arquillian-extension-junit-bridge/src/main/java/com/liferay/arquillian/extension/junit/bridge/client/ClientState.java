...
public class ClientState {
	...
	private long _installBundle(
		...
		// Allow overriding the report server hostname for Docker/WSL scenarios
		String hostAddress = System.getProperty(
			"liferay.arquillian.report.host", inetAddress.getHostAddress());


		byte[] bytes = BndBundleUtil.createBundle(
			filteredMethodNamesMap, hostAddress, port,
			passCode);
